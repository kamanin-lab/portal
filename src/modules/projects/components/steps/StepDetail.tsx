    ...
    <div className="p-[24px] max-w-[760px] max-[768px]:p-[16px]">
      ...
      <div className="mb-[18px]">
        ...
        <div className="flex items-start justify-between gap-[12px]">
          <h2 className="text-[20px] font-bold text-text-primary tracking-[-0.02em] leading-[1.2]">
            {step.title}
          </h2>
      ...
      <Tabs defaultValue="overview">
        ...
        <TabsContent value="overview" className="pt-[18px]">
          <StepOverviewTab step={step} project={project} />
        </TabsContent>
        <TabsContent value="files" className="pt-[18px]">
          <StepFilesTab step={step} />
        </TabsContent>
        <TabsContent value="discussion" className="pt-[18px]">
